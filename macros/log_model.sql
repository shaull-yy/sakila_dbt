...
{% if start_end == 'start' %}
  insert into dwh.dbt_log (id, model, start_date, end_date, run_duration, run_dur_sec, etl_date_utc) values('{{ invocation_id}}', '{{this}}', now(), null, null, null, '{{ run_started_at }}'::timestamp);
{%else %}
